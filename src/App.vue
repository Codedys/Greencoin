<template>
  ...
  <router-view />
  <!-- start of footer -->
  <footer class="mx-auto h-full w-full border-t-4 mt-8 md:w-1/2 lg:4/5 ">
    <div class=" mt-6 flex ">
      <div class="ml-8 flex flex-col flex-1 space-y-4 justify-start">
        ...
        <div class=" flex space-y-4 flex-col mr-8">
