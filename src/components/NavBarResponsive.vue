<template>
  <div class="w-full fixed top-0 right-0 left-0 h-52 border-b-2 flex flex-col custombackground opacity-95">
    <div class=" pl-2 flex justify-start items-center mt-3 ml-4">
